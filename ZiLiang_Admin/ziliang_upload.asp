...
<body>
<form name="form1" method="post" action="ziliang_upfile.asp" enctype="multipart/form-data" >
...
<tr> 
<td align="center" background="images/admin_bg_1.gif"><b><font color="#000000">图片上传
